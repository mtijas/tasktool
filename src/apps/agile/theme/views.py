...
def list_themes(request):
    ...
    return render(request, 'agile/theme/theme_table.html', {'themes': themes})

@login_required
@permission_required('theme.view_theme')
def get_table(request):
    themes = Theme.objects.order_by('title')
    return render(request, 'agile/theme/table_rows.html', {'themes': themes})
...
class ThemeCreateView(LoginRequiredMixin, PermissionRequiredMixin, View):
    ...
    def get(self, request):
        form = ThemeEditForm()
        return render(request, 'agile/theme/quick_edit_form.html', {'form': form})
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            response = render(request, 'agile/theme/quick_edit_form.html', {'form': form})
        return response
...
class ThemeUpdateView(LoginRequiredMixin, PermissionRequiredMixin, View):
    ...
    def get(self, request, theme_id):
        ...
        return render(request, 'agile/theme/quick_edit_form.html', {'form': form, 'theme': theme})
